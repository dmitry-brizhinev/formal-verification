...
Theorem WP_parameter_cons_Deterrence_int_ensures_default : forall (this_10:(Jessie_memory_model.pointer
  ...
  0%Z usObject_alloc_table) /\ ((states_initialised usDeterrence_states
  usObject_alloc_table) /\ ((0%Z <= array_index)%Z /\
  ((array_index < 100%Z)%Z /\
  ((0%R <= usDeterrence_IRRATIONAL_PROBABILITY)%R /\
  ((usDeterrence_IRRATIONAL_PROBABILITY <= 1%R)%R /\
  ((0%R <= usDeterrence_ATTRIBUTION_PROBABILITY)%R /\
  ((usDeterrence_ATTRIBUTION_PROBABILITY <= 1%R)%R /\ (states_valid_up_to
  usDeterrence_states array_index usObject_alloc_table intM_intP
  usDeterrenceM_DeterrenceP doubleM_doubleP usDeterrence_retaliationTable
  usDeterrence_numRetaliates usDeterrence_numIgnores
  usDeterrence_index))))))))) ->
  ...
  this_10 (Jessie_memory_model.null : (Jessie_memory_model.pointer
  usObject)))) -> forall (i_20:Z), ((0%Z <= i_20)%Z /\
  (i_20 < array_index)%Z) ->
  ~ ((Jessie_memory_model.select usDeterrenceM_DeterrenceP
  (Jessie_memory_model.shift usDeterrence_states i_20)) = this_10).
...
usDeterrenceM_DeterrenceP (h1,(h2,(h3,(h4,(h5,(h6,(h7,(h8,h9))))))))
usDeterrence_index1 h10 usDeterrence_value1 h11 usDeterrence_numIgnores1 h12
usDeterrence_numRetaliates1 h13 usDeterrence_retaliationTable1 h14 i_20
(h15,h16).
