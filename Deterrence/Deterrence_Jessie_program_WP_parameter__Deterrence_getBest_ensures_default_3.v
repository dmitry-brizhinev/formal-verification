...
(* Why3 goal *)
Theorem WP_parameter__Deterrence_getBest_ensures_default : forall (usDeterrence_states:(Jessie_memory_model.pointer
  ...
  usDeterrence_retaliationTable usDeterrence_numRetaliates
  usDeterrence_numIgnores usDeterrence_index) -> exists k_1:Z,
  (0%Z <= k_1)%Z /\ ((k_1 < 1%Z)%Z /\
  ((Jessie_memory_model.select usDeterrenceM_DeterrenceP
  (Jessie_memory_model.shift usDeterrence_states
  k_1)) = (Jessie_memory_model.select usDeterrenceM_DeterrenceP
