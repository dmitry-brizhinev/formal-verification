...
(* Why3 goal *)
Theorem WP_parameter__Deterrence_getWorst_ensures_default : forall (usDeterrence_states:(Jessie_memory_model.pointer
  usObject)) (usDeterrence_index:(Jessie_memory_model.memory usObject Z))
  (usDeterrence_numIgnores:(Jessie_memory_model.memory usObject
  (Jessie_memory_model.pointer usObject)))
  (usDeterrence_numRetaliates:(Jessie_memory_model.memory usObject
  (Jessie_memory_model.pointer usObject)))
  ...
  (usObject_alloc_table:(Jessie_memory_model.alloc_table usObject))
  (usDeterrenceM_DeterrenceP:(Jessie_memory_model.memory usObject
  (Jessie_memory_model.pointer usObject))), (states_valid usDeterrence_states
  usObject_alloc_table intM_intP usDeterrenceM_DeterrenceP doubleM_doubleP
  usDeterrence_retaliationTable usDeterrence_numRetaliates
  usDeterrence_numIgnores usDeterrence_index) -> exists k_2:Z,
  (0%Z <= k_2)%Z /\ ((k_2 < 1%Z)%Z /\
  ((Jessie_memory_model.select usDeterrenceM_DeterrenceP
  (Jessie_memory_model.shift usDeterrence_states
  k_2)) = (Jessie_memory_model.select usDeterrenceM_DeterrenceP
  (Jessie_memory_model.shift usDeterrence_states 0%Z)))).
intros usDeterrence_states usDeterrence_index usDeterrence_numIgnores
usDeterrence_numRetaliates usDeterrence_retaliationTable doubleM_doubleP
intM_intP usObject_alloc_table usDeterrenceM_DeterrenceP h1.
exists 0%Z.
auto with *.
