...
(* Why3 goal *)
Theorem WP_parameter_cons_Deterrence_int_ensures_default : forall (this_10:(Jessie_memory_model.pointer
  usObject)) (array_index:Z),
  forall (usDeterrence_value:(Jessie_memory_model.memory usObject R))
  (usDeterrence_states:(Jessie_memory_model.pointer usObject))
  (usDeterrence_index:(Jessie_memory_model.memory usObject Z))
  (usDeterrence_numIgnores:(Jessie_memory_model.memory usObject
  (Jessie_memory_model.pointer usObject)))
  (usDeterrence_numRetaliates:(Jessie_memory_model.memory usObject
  ...
  (usDeterrenceM_DeterrenceP:(Jessie_memory_model.memory usObject
  (Jessie_memory_model.pointer usObject))), ((valid_struct_Object this_10 0%Z
  0%Z usObject_alloc_table) /\
  (((((Jessie_memory_model.offset_max usObject_alloc_table
  usDeterrence_states) + 1%Z)%Z = 100%Z) /\ (Jessie_memory_model.valid
  usObject_alloc_table usDeterrence_states)) /\ (((0%Z < array_index)%Z \/
  (0%Z = array_index)) /\ ((array_index < 100%Z)%Z /\
  (((0%R < usDeterrence_IRRATIONAL_PROBABILITY)%R \/
  (0%R = usDeterrence_IRRATIONAL_PROBABILITY)) /\
  (((usDeterrence_IRRATIONAL_PROBABILITY < 1%R)%R \/
  (usDeterrence_IRRATIONAL_PROBABILITY = 1%R)) /\
  (((0%R < usDeterrence_ATTRIBUTION_PROBABILITY)%R \/
  (0%R = usDeterrence_ATTRIBUTION_PROBABILITY)) /\
  (((usDeterrence_ATTRIBUTION_PROBABILITY < 1%R)%R \/
  (usDeterrence_ATTRIBUTION_PROBABILITY = 1%R)) /\ ((forall (i:Z),
  ((0%Z <= i)%Z /\ (i < array_index)%Z) ->
  ((Jessie_memory_model.select usDeterrence_index
  (Jessie_memory_model.select usDeterrenceM_DeterrenceP
  (Jessie_memory_model.shift usDeterrence_states i))) = i)) /\
  forall (i_0:Z), ((0%Z <= i_0)%Z /\ (i_0 < array_index)%Z) -> (state_valid
  usDeterrence_states (Jessie_memory_model.select usDeterrenceM_DeterrenceP
  (Jessie_memory_model.shift usDeterrence_states i_0)) i_0
  usObject_alloc_table intM_intP usDeterrenceM_DeterrenceP doubleM_doubleP
  usDeterrence_retaliationTable usDeterrence_numRetaliates
  usDeterrence_numIgnores usDeterrence_index)))))))))) ->
  forall (usDeterrence_index1:(Jessie_memory_model.memory usObject Z)),
  (usDeterrence_index1 = (Jessie_memory_model.store usDeterrence_index
  this_10 0%Z)) -> forall (usDeterrence_value1:(Jessie_memory_model.memory
  usObject R)),
  (usDeterrence_value1 = (Jessie_memory_model.store usDeterrence_value
  this_10 0%R)) ->
  forall (usDeterrence_numIgnores1:(Jessie_memory_model.memory usObject
  (Jessie_memory_model.pointer usObject))),
  (usDeterrence_numIgnores1 = (Jessie_memory_model.store usDeterrence_numIgnores
  this_10 (Jessie_memory_model.null : (Jessie_memory_model.pointer
  usObject)))) ->
  forall (usDeterrence_numRetaliates1:(Jessie_memory_model.memory usObject
  (Jessie_memory_model.pointer usObject))),
  (usDeterrence_numRetaliates1 = (Jessie_memory_model.store usDeterrence_numRetaliates
  this_10 (Jessie_memory_model.null : (Jessie_memory_model.pointer
  usObject)))) ->
  forall (usDeterrence_retaliationTable1:(Jessie_memory_model.memory usObject
  (Jessie_memory_model.pointer usObject))),
  (usDeterrence_retaliationTable1 = (Jessie_memory_model.store usDeterrence_retaliationTable
  this_10 (Jessie_memory_model.null : (Jessie_memory_model.pointer
  usObject)))) -> forall (i:Z), ((0%Z <= i)%Z /\ (i < array_index)%Z) ->
  ((Jessie_memory_model.select usDeterrence_index1
  (Jessie_memory_model.select usDeterrenceM_DeterrenceP
  (Jessie_memory_model.shift usDeterrence_states i))) = i).
intros this_10 array_index usDeterrence_value usDeterrence_states
usDeterrence_index usDeterrence_numIgnores usDeterrence_numRetaliates
...
usDeterrenceM_DeterrenceP
(h1,((h2,h3),(h4,(h5,(h6,(h7,(h8,(h9,(h10,h11))))))))) usDeterrence_index1
h12 usDeterrence_value1 h13 usDeterrence_numIgnores1 h14
usDeterrence_numRetaliates1 h15 usDeterrence_retaliationTable1 h16 i
(h17,h18).
